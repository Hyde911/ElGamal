 ...
 * @author marr
 */
public class ElGamalAlgorithmImplementation {
    ...
    public byte[] decrypt(byte[] crypt, Map<String, BigInt>keys) {
    ...
    private Map<String, BigInt> generateKeys(Map<String,BigInt>keys) {
        keys.clear();
